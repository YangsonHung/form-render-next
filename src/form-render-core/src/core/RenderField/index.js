...
const RenderField = (props) => {
  ...
  const { debounceInput, readOnly, disabled, showValidate, validateMessages, locale, watch } =
    useStore2();
  ...
  const contentClass =
    hasError && showValidate ? _contentClass + ' ant-form-item-has-error' : _contentClass;
